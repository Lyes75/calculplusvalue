  ...
  return (
    <html lang="fr">
      <head>
        ...
        <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-4834572211278483" crossOrigin="anonymous" />
            ...
            <div style={{ borderTop: "1px solid rgba(255,255,255,0.1)", paddingTop: 20 }}>
              ...
              <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: 8 }}>
                <span style={{ fontSize: 11, color: "#6E6B8A", display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <span style={{ color: "#4a4870" }}>|</span>
                  <a href="/contact" style={{ color: "#9B97C4", textDecoration: "none" }}>Contact</a>
                </span>
