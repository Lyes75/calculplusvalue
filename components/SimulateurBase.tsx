...
export default function SimulateurBase({
  ...
  const [situationVendeur, setSituationVendeur] = useState<"resident" | "non-resident-ue" | "non-resident-hors-ue" | "sci-ir" | "sci-is">(
    (defaultSituation as "resident" | "non-resident-ue" | "non-resident-hors-ue" | "sci-ir" | "sci-is") ?? "resident"
  );
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: C.bg, minHeight: "100vh", color: C.text }}>
      ...
      <div style={{ maxWidth: 900, margin: "0 auto", padding: "24px 16px 60px" }}>
        ...
        {/* ── Formulaire ── */}
        <div data-simulator-form style={{ background: C.card, borderRadius: 14, border: `1px solid ${C.border}`, padding: formCollapsed ? "12px 20px" : "24px 20px", marginBottom: 14, transition: "padding 0.2s" }}>
          {formCollapsed && (
          ...
          <div style={{ display: formCollapsed ? "none" : "block" }}>
          {lockedTypeLabel && (
